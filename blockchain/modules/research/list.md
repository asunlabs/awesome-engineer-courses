...
2. [Decentralized storage: Swarm](https://www.ethswarm.org/#:~:text=Swarm%20is%20a%20system%20of,contracts%20on%20the%20Ethereum%20blockchain.)
3. [NFT storage](https://nft.storage/)
4. [Pinata cloud docs](https://docs.pinata.cloud/)
5. [Mutable IPFS - w3name github](https://github.com/web3-storage/w3name)
6. [Mutable IPFS - w3name actions](https://github.com/pawanpaudel93/w3name-action)
